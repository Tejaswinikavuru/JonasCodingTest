...
namespace UnitTests
{
	...
	public class CompanyRepositoryTests
	{
		...
		public async Task GetAllCompaniesAsync_ShouldReturnAllCompanies()
		{
			...
			_mockDbWrapper.FindAllAsync().Returns((IEnumerable<Company>)Task.FromResult(companies));
		...
		public async Task GetCompanyByCompanyCodeAsync_ShouldReturnCompany_WhenFound()
		{
            ...
            _mockDbWrapper.FindAsync(Arg.Any<Expression<Func<Company, bool>>>()).Returns((IEnumerable<Company>)Task.FromResult(new List<Company> { company }));
		...
		public async Task GetCompanyByCompanyCodeAsync_ShouldReturnNull_WhenNotFound()
		{
			// Arrange
			var companyCode = "C1";
			_mockDbWrapper.FindAsync(Arg.Any<Expression<Func<Company, bool>>>()).Returns((IEnumerable<Company>)Task.FromResult(new List<Company>()));
		...
		public async Task CreateCompanyAsync_ShouldReturnFailure_WhenCompanyAlreadyExists()
		{
			...
			_mockDbWrapper.FindAsync(Arg.Any<Expression<Func<Company, bool>>>()).Returns((IEnumerable<Company>)Task.FromResult(new List<Company> { existingCompany }));
		...
		public async Task UpdateByCodeAsync_ShouldReturnSuccess_WhenUpdatedSuccessfully()
		{
			...
			_mockDbWrapper.FindAsync(t => t.CompanyCode.Equals(companyCode)).Returns((IEnumerable<Company>)Task.FromResult(new List<Company> { existingCompany }));
		...
		public async Task UpdateByCodeAsync_ShouldReturnFailure_WhenCompanyNotFound()
		{
			...
			var companyCode = "C1";
			var updatedCompany = new Company { CompanyCode = companyCode };
			_mockDbWrapper.FindAsync(t => t.CompanyCode.Equals(companyCode)).Returns((IEnumerable<Company>)Task.FromResult(new List<Company>()));
		...
		public async Task DeleteByCodeAsync_ShouldReturnTrue_WhenCompanyDeletedSuccessfully()
		{
			...
			var existingCompany = new Company { CompanyCode = companyCode };
			_mockDbWrapper.FindAsync(t => t.CompanyCode.Equals(companyCode)).Returns((IEnumerable<Company>)Task.FromResult(new List<Company> { existingCompany }));
			_mockDbWrapper.DeleteAsync(Arg.Any<Expression<Func<Company, bool>>>()).Returns(Task.FromResult(true));
		...
		public async Task GetCompanyByCompanyNameAsync_ShouldReturnCompany_WhenFound()
		{
			...
			_mockDbWrapper.FindAsync(t => t.CompanyName.Equals(companyName)).Returns((IEnumerable<Company>)Task.FromResult(new List<Company> { company }));
		...
		public async Task GetCompanyByCompanyNameAsync_ShouldReturnNull_WhenNotFound()
		{
			// Arrange
			var companyName = "MyCompany";
			_mockDbWrapper.FindAsync(t => t.CompanyName.Equals(companyName)).Returns((IEnumerable<Company>)Task.FromResult(new List<Company>()));
